...
jQuery(document).ready(function($) {
		...
		$("#style-switcher .aqua" ).click(function(){
			$("#colors" ).attr("href", "styles/colors/color-aqua.styles" );
			return false;
		});

		$("#style-switcher .green_switcher" ).click(function(){
			$("#colors" ).attr("href", "styles/colors/color-green.styles" );
			return false;
		});

		$("#style-switcher .orange" ).click(function(){
			$("#colors" ).attr("href", "styles/colors/color-orange.styles" );
			return false;
		});

		$("#style-switcher .blue" ).click(function(){
			$("#colors" ).attr("href", "styles/colors/color-blue.styles" );
			return false;
		});
