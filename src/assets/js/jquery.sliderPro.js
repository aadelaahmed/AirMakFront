...
;(function( window, $ ) {
	...
	SliderPro.prototype = {
		...
		_moveTo: function( position, instant, callback ) {
			...
			if ( ( this.supportedAnimation === 'styles-3d' || this.supportedAnimation === 'styles-2d' ) && this.isIE === false ) {
				var transition,
					left = this.settings.orientation === 'horizontal' ? position : 0,
					top = this.settings.orientation === 'horizontal' ? 0 : position;

				if ( this.supportedAnimation === 'styles-3d' ) {
		...
		_resizeHeightTo: function( height ) {
			...
			if ( this.supportedAnimation === 'styles-3d' || this.supportedAnimation === 'styles-2d' ) {
		...
		getSupportedAnimation: function() {
			...
			if ( isCSSTransitions === true ) {
				...
				if ( typeof div.style.WebkitPerspective !== 'undefined' || typeof div.style.perspective !== 'undefined' ) {
					this.supportedAnimation = 'styles-3d';
				}

				// Additional checks for Webkit
				if ( this.supportedAnimation === 'styles-3d' && typeof div.styleWebkitPerspective !== 'undefined' ) {
				...
				if ( this.supportedAnimation === null && ( typeof div.style['-webkit-transform'] !== 'undefined' || typeof div.style.transform !== 'undefined' ) ) {
					this.supportedAnimation = 'styles-2d';
				}
			} else {
		...
		show: function( callback ) {
			...
			if ( this.supportedAnimation === 'javascript' ) {
				...
				if ( typeof this.data.showTransition !== 'undefined' ) {
					...
					start[ this.vendorPrefix + 'transform' ] += this.supportedAnimation === 'styles-3d' ? ' translate3d(' + transformValues + ', 0)' : ' translate(' + transformValues + ')';
					target[ this.vendorPrefix + 'transform' ] += this.supportedAnimation === 'styles-3d' ? ' translate3d(0, 0, 0)' : ' translate(0, 0)';
		...
		hide: function( callback ) {
			...
			if ( this.supportedAnimation === 'javascript' ) {
				...
				if ( typeof this.data.hideTransition !== 'undefined' ) {
					...
					target[ this.vendorPrefix + 'transform' ] += this.supportedAnimation === 'styles-3d' ? ' translate3d(' + transformValues + ', 0)' : ' translate(' + transformValues + ')';
					target[ this.vendorPrefix + 'transition' ] += ', ' + this.vendorPrefix + 'transform ' + duration + 's';
				}
